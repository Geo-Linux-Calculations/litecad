...
#define LC_WS_VIEWTABS    512  // Window has View Tabs (border frame automatically added)
#define LC_WS_FILETABS    1024 // Window has File Tabs (border frame automatically added)
...
#define LC_CMD_PAGEVPORT      56  // Display layout of active viewport (called by popup menu on AVP)
...
#define LC_CMD_TIN_LOAD       301   // Add new TIN entity by loading TIN model from a file
#define LC_CMD_TIN_LOADPT     302   // Add new TIN entity by loading TIN points from a file
...
// 3D
#define LC_CMD_3DVIEW         601   // enable/disable 3D view (Tab). CmdPrm: 0-switch, 1-on, 2-off
...
#define LC_PROP_G_RULERW        23   // RW int; ruler width (pixels)
#define LC_PROP_G_RULERFS       24   // RW int; ruler font size (pixels)
...
#define LC_PROP_G_MINCHARSIZE   41   // RW int; 3..15 below this value a char will be drawn as a rectangle
...
#define LC_PROP_G_TABFILE       45   //  W string; the file to be opened in lcCreateWindow with LC_WS_FILETABS style
#define LC_PROP_G_MSGSAVEAS     46   // RW bool; display message "Saved As" in the function _lcDrwSave
...
#define LC_PROP_G_HANDLE        54   // R  handle; g_PropHandle
#define LC_PROP_G_DELKEYERASE   55   // RW bool; using <Delete> key for "Erase" command (LC_CMD_ERASE)

// Selection Options
#define LC_PROP_SEL_PICKBOXSIZE   61   // RW int; Half-size of selecting square, in pixels
#define LC_PROP_SEL_PICKBYRECT    62   // RW bool; Implied windowing for objects selection (AutoCAD PICKAUTO)
#define LC_PROP_SEL_PICKDRAG      63   // RW bool; Selection Rect: Press and Drag (same as AutoCAD PICKDRAG system variable)
#define LC_PROP_SEL_PICKADD       64   // RW bool; Controls whether subsequent selections replace the current selection set or add to 
#define LC_PROP_SEL_PICKBYLAYER   65   // RW bool; Select entities only on active layer
#define LC_PROP_SEL_PICKINPGON    66   // RW bool; Select polygons by click on inner area
#define LC_PROP_SEL_PICKINPGONF   67   // RW bool; -/- Only filled polygons
#define LC_PROP_SEL_PICKINIMG     68   // RW bool; Select images by click on inner area
...
#define LC_PROP_SEL_HATCHFILL     72   // RW bool; Draw hatch filling when entity is selected
...
#define LC_PROP_SEL_GRIPENTLIM    77   // RW int; Max number of selected entities to display grips
...
#define LC_PROP_G_CAMERA_INAME  92   // R  string; name of camera by index (LC_PROP_G_CAMERA_I)
...
#define LC_PROP_G_CAMERA_COFO   99   // R  int; color format (LC_COFO_RGB24 and others)
#define LC_PROP_G_CAMERA_BITS   100  // R  handle|int; pointer to image bits
...
#define LC_PROP_G_TIN_PT0  270  // R  handle; result of lcTIN_TriGetEdge
#define LC_PROP_G_TIN_PT1  271  // R  handle; result of lcTIN_TriGetEdge
#define LC_PROP_G_TIN_TR   272  // R  handle; result of lcTIN_TriGetEdge
...
#define LC_PROP_WND_RULERSENABLE    320    // R  bool;   true if window was created with LC_WS_RULERS flag
...
#define LC_PROP_WND_DROPFILES       329    // RW bool; Registers whether a window accepts dropped files
...
#define LC_PROP_WND_MAGNIFIER       340    // RW bool; display magnifier at window rig-bot corner
...
#define LC_PROP_WND_CURSORARROW     348    // RW bool|int|handle; Enable arrow cursor | set cursor (LC_CURSOR_ARROW or other)
#define LC_PROP_WND_CURSORCROSS     349    // RW bool; Enable crosshair cursor
#define LC_PROP_WND_CURSORSIZE      350    // RW int; Size of crosshair cursor, % of screen, if negative - size in pixels
#define LC_PROP_WND_CURSORPBOX      351    // RW bool; Enable cursor pickbox rect
#define LC_PROP_WND_COORDS          352    // RW bool; display cursor coords at left-bottom corner
#define LC_PROP_WND_ENT             353    // R  handle; picked entity (see lcWndPickEnt function)
#define LC_PROP_WND_PROPWND         354    // R  handle; Handle to properties window
#define LC_PROP_WND_BLOCKBPT        355    // RW bool; display block basepoint
#define LC_PROP_WND_LWMODE          355    // RW int;  line width mode (LC_LW_THIN, LC_LW_REAL, LC_LW_PIXEL)
...
#define LC_PROP_WND_ALPHABLEND      360    // RW bool; enable alpha blend (transparent filling)
#define LC_PROP_WND_STDBLKFRAME     361    // RW bool; draw red frame around the window if standard block is active
#define LC_PROP_WND_BLKBASEPT       362    // RW bool; display block basepoint
#define LC_PROP_WND_SIZE            363    // R  string; window size, pixels (format "%d x %d", PSWidth(), PSHeight() )
#define LC_PROP_WND_DTIME           364    // R  int; redraw time, milliseconds
#define LC_PROP_WND_DRAWPAPER       365    // RW bool; draw paper sheet for "Paper space" blocks
...
#define LC_PROP_WND_COMMAND         368    // R  int|handle|bool; Id of active command | handle to active command | TRUE if has active command
#define LC_PROP_WND_CMD             368    // same as LC_PROP_WND_COMMAND
#define LC_PROP_WND_CMDENT1         369    // RW bool; TRUE - only one entity added by command, FALSE - several entities
#define LC_PROP_WND_OSNAP           370    // RW int|bool; object snap mode  LC_OSNAP_NODE and others | On/Off
#define LC_PROP_WND_OSNAPMENU       371    // RW bool; display "object snap" menu on <shift>+<RBDown> (CBaseWnd::BaseOnRButtonDown)
...
#define LC_PROP_WND_PTRACK_DIST     376    // RW bool|float; use distance step along polar vector | value of dist. step
...
#define LC_PROP_WND_RSNAPCOLORM     410    // RW int; Rectangle filling color on Model space
#define LC_PROP_WND_RSNAPCOLORP     411    // RW int; Rectangle filling color on Paper space

#define LC_PROP_WND_PANSTEP         420    // RW int; Minimal step, pixels
#define LC_PROP_WND_PANLW           421    // RW bool; optimize line width (draw as 1pix size)
#define LC_PROP_WND_PANIMAGE        422    // RW bool; optimize raster images (draw as hatch)
#define LC_PROP_WND_PANFILL         423    // RW bool; optimize polygon filling (don't fill)
#define LC_PROP_WND_PANPIXSZ        424    // RW bool; reduce resolution (increase pixel size)

#define LC_PROP_WND_MEASCOLORPNT    430    // RW int; COLORREF for points of DIST, AREA tools
#define LC_PROP_WND_MEASCOLORLINE   431    // RW int; COLORREF for lines of DIST, AREA tools
...
#define LC_PROP_WND_XLINEANG        444    // RW float; direction angle for command LC_CMD_XLINE
#define LC_PROP_WND_BGIMAGE         445    // RW string|bool; Background image filename | Display
#define LC_PROP_WND_LTVIEWMIN       446    // RW int; Linetype visibility, min size of pattern, pixels
#define LC_PROP_WND_LTVIEWMAX       447    // RW int; Linetype visibility, max size of pattern, pixels

#define LC_PROP_WND_FRAME_LEFT      451    // R  int; Left position on parent window (pixels)
#define LC_PROP_WND_FRAME_TOP       452    // R  int; Top position on parent window (pixels)
...
#define LC_PROP_TINPNT_ONAME    708  // RW string; own name (overrides name of point type)
...
#define LC_PROP_DRW_MAXHATDASH      3023    // RW int; max number of hatch dashes in Hatch entities
#define LC_PROP_DRW_PROPLINFILL     3024    // RW bool; if TRUE then display LinFill item in Properties window
#define LC_PROP_DRW_PROPZTH         3025    // RW bool; if TRUE then display Z and Thickness items in Properties window
...
#define LC_PROP_DRW_LUNITS          3031   // RW int; Linear units (LC_LUNIT_SCIEN and others)
#define LC_PROP_DRW_LUPREC          3032   // RW int; Precision for linear units (number of decimal digits)
#define LC_PROP_DRW_AUNITS          3033   // RW int; Angle units (LC_AUNIT_DEGREE and others)
#define LC_PROP_DRW_AUPREC          3034   // RW int; Precision for angular units (number of decimal digits)
#define LC_PROP_DRW_ANGBASE         3035   // RW int; base angle
#define LC_PROP_DRW_ANGDIR          3036   // RW int; angle direction, 0-counterclockwise, 1-clockwise
#define LC_PROP_DRW_INSUNITS        3037   // RW int;  (LC_INSUNIT_UNDEFINED and others)
#define LC_PROP_DRW_PDMODE          3038   // RW int; default point draw mode, LC_POINT_PIXEL and others   
#define LC_PROP_DRW_PDSIZE          3039   // RW float; default point size, negative value means percent of a window
#define LC_PROP_DRW_CMLJUST         3040   // RW int; Current multiline justification 0 = Top; 1 = Middle; 2 = Bottom
...
#define LC_PROP_DRW_COLORPAPER      3057    // RW int; color of paper sheet on Paper Space
...
#define LC_PROP_DRW_LAYER           3081    // RW handle|string; Handle to active layer|Name of active layer
#define LC_PROP_DRW_LINETYPE        3082    // RW handle|string; Handle to active linetype|Name of active linetype
#define LC_PROP_DRW_LTSCALE         3083    // RW float; active linetype scale
#define LC_PROP_DRW_TEXTSTYLE       3084    // RW handle|string; Handle to active text style|Name of active text style
#define LC_PROP_DRW_DIMSTYLE        3085    // RW handle|string; Handle to active dim style|Name of active dim style
#define LC_PROP_DRW_PNTSTYLE        3086    // RW handle|string; Handle to active point style|Name of active point style
#define LC_PROP_DRW_MLSTYLE         3087    // RW handle|string; Handle to active mline style|Name of active mline style
#define LC_PROP_DRW_BLOCK           3089    // RW handle|string; Handle to active block|Name of active block
#define LC_PROP_DRW_VISBLOCK        3090    // RW handle|string; Handle to currently visible block|Name of currently visible block
#define LC_PROP_DRW_LAYOUT          3091    // RW handle|string; Handle to active layout (Tab)
#define LC_PROP_DRW_BARCTYPE        3092    // RW int; active barcode type, LC_BARTYPE_CODE39 and others
#define LC_PROP_DRW_BARCSOLID       3093    // RW bool; draw barcode without filling option
#define LC_PROP_DRW_LWMODE          3094    // RW int;  line width mode (LC_LW_THIN, LC_LW_REAL, LC_LW_PIXEL)
#define LC_PROP_DRW_LWSCALE         3095    // RW float; line width screen scale, mm / pixel
#define LC_PROP_DRW_LWIDTH          3096    // RW int; active Linewidth (for new entities)
#define LC_PROP_DRW_LWDEFAULT       3097    // RW int; Default linewidth (if linewidth==LC_LWIDTH_DEFAULT)
#define LC_PROP_DRW_LINFILL         3098    // RW handle|string; Handle to active linfill|Name of active linfill
#define LC_PROP_DRW_TINPNT          3102    // R  handle; active TIN point (snapped) 
#define LC_PROP_DRW_TINTR           3103    // R  handle; TIN triangle used by COkTIN::GetZ(..)
...
#define LC_PROP_DRW_LIM_MINPIXSIZE  3181    // RW float; minimal pixel size (drawing units)
...
#define LC_PROP_BLOCK_LAYOUTORDER    4816  // RW int; value used for window tabs order  // undoc
...
#define LC_PROP_BLOCK_ODA_LAYOUTHANDLE 4829  // RW string; ODA layout handle  // undoc
#define LC_PROP_BLOCK_ODA_VPORTHANDLE  4830  // RW string; ODA overall viewport handle  // undoc
...
#define LC_PROP_ENT_FROMCB        5035  // R  bool; TRUE if entity was added from ClipBoard
// Outline Color 
...
#define LC_PROP_PLINE_ODSOLID    5326  // RW bool; made from SOLID entity at ODA import
...
#define LC_PROP_BLKREF_ONS_ANGLE 5548  // RW bool; Specify rotation angle on-screen
#define LC_PROP_BLKREF_RETURN    5549  // R  handle; Handle to inserted object (block reference) after  execution
...
#define LC_PROP_TIN_COLTRF       7079  // RW int; color of triangle filling (used in step triangulation)
#define LC_PROP_TIN_COLFRONT0    7080  // RW int; color of start front line (used in step triangulation)
#define LC_PROP_TIN_COLFRONT     7081  // RW int; color of front line (used in step triangulation)
...
typedef void (CALLBACK* F_WAITPOINT) (int FuncPrm, HANDLE hLcWnd);
typedef void (CALLBACK* F_REDRAW) (HANDLE hLcWnd, int Elapsed);
...
BOOL   LCAPI lcTIN_Triangulate   (HANDLE hTIN, HANDLE hLcWnd);  // LC_CMD_TIN_BNDTRANG
