...
#define LC_WS_VIEWTABS    256  // Window has View Tabs
...
// View mode for lcViewSetProjection
#define LC_VIEW_TOP         0    // Set the 3D view of the drawing from Top (Nadir or Plan view)
#define LC_VIEW_PLAN        0    // same as LC_VIEW_TOP
#define LC_VIEW_BOTTOM      1    // Set the 3D view of the drawing from Bottom 
#define LC_VIEW_LEFT        2    // Set the 3D view of the drawing from Left 
#define LC_VIEW_RIGHT       3    // Set the 3D view of the drawing from Right 
#define LC_VIEW_FRONT       4    // Set the 3D view of the drawing from Front 
#define LC_VIEW_BACK        5    // Set the 3D view of the drawing from Back 
#define LC_VIEW_SW          6    // Set the isometric 3D view of the drawing from South-West 
#define LC_VIEW_SE          7    // Set the isometric 3D view of the drawing from South-East 
#define LC_VIEW_NE          8    // Set the isometric 3D view of the drawing from North-East 
#define LC_VIEW_NW          9    // Set the isometric 3D view of the drawing from North-West 
#define LC_VIEW_ISOMETRIC   10   // Set the isometric 3D view of the drawing via horiz. and vert. angles
#define LC_VIEW_PERSPECTIVE 11

// Edit plane for isometric view
#define LC_PLANE_XY         0
#define LC_PLANE_XZ         1
#define LC_PLANE_YZ         2
...
//#define LC_ENT_ATTDEF      119  // Attribute definition
...
#define LC_CMD_RECT           206  // Draw Rectangle
#define LC_CMD_CIRCLE         207  // Draw Circle
#define LC_CMD_ARC            208  // Draw Arc
#define LC_CMD_ELLIPSE        209  // Draw Ellipse
#define LC_CMD_TEXT           210  // Draw Text
#define LC_CMD_MTEXT          211  // Draw Multiline Text
#define LC_CMD_ATEXT          212  // Draw Arc Text
#define LC_CMD_INSERT         213  // Insert Block
#define LC_CMD_VPORT          214  // Insert Viewport
#define LC_CMD_BASEPOINT      215  // define block basepoint
#define LC_CMD_ATTDEF         216  // Draw Attribute Definition
#define LC_CMD_HATCH          217  // Draw Hatch
#define LC_CMD_BOUNDARY       218  // Draw boundary
#define LC_CMD_WTEXT          219  // Draw WinText
...
#define LC_CMD_TRIM           318  // // undoc
#define LC_CMD_EXTEND         319  // // undoc
#define LC_CMD_OFFSET         320  // // undoc
#define LC_CMD_OFFSET_POINT   0 
#define LC_CMD_OFFSET_DIST    1
#define LC_CMD_BREAK          321  // // undoc
...
#define LC_CMD_VIEW_TOP       430  // Set 3D view to overhead (Nadir or Plan view)
#define LC_CMD_VIEW_BOTTOM    431  // Set 3D view to obverse
#define LC_CMD_VIEW_LEFT      432  // Set 3D view to the left
#define LC_CMD_VIEW_RIGHT     433  // Set 3D view to the right
#define LC_CMD_VIEW_FRONT     434  // Set 3D view to the front
#define LC_CMD_VIEW_BACK      435  // Set 3D view to the back
#define LC_CMD_VIEW_SW        436  // Set isometric 3D view to the SouthWest
#define LC_CMD_VIEW_SE        437  // Set isometric 3D view to the SouthEast
#define LC_CMD_VIEW_NE        438  // Set isometric 3D view to the NorthEast
#define LC_CMD_VIEW_NW        439  // Set isometric 3D view to the NorthWest
#define LC_CMD_VIEW_SET       440  // Set isometric 3D view via dialog
...
#define LC_PROP_G_DIRDLL            3      // R  string; directory of Litecad.dll
#define LC_PROP_G_DIRCFG            4      // R  string; directory of Litecad config files
#define LC_PROP_G_DIRFONTS          5      // R  string; directory of Litecad fonts
#define LC_PROP_G_FILEHATCH         6      // RW string; hatch patterns file
#define LC_PROP_G_FILELTYPE         7      // RW string; linetype file
#define LC_PROP_G_TEMPLATE          8      // RW string; default template file for new drawings
#define LC_PROP_G_DIRTEMPLATE       9      // RW string; additional directory for templates (default are Litecad dll dir and \Template subdir)
#define LC_PROP_G_OWNDXFR           10     // RW bool; on/off own dxf support (read)
#define LC_PROP_G_OWNDXFW           11     // RW bool; on/off own dxf support (write)
#define LC_PROP_G_PANSTEP           12     // RW int; Minimal step, pixels    // undoc
#define LC_PROP_G_PANFILLING        13     // RW bool; Display polygon filling  // undoc
#define LC_PROP_G_PANHATCH          14     // RW bool; Display hatch pattern  // undoc
#define LC_PROP_G_PANPLWIDTH        15     // RW bool; Display polyline width  // undoc
#define LC_PROP_G_PANLWEIGHT        16     // RW bool; Display lineweight  // undoc
#define LC_PROP_G_PANFILLCHAR       17     // RW bool; Display text char filling   // undoc
#define LC_PROP_G_PANRECTCHAR       18     // RW int; Draw text char as rect below the size, pixel  // undoc
#define LC_PROP_G_CURSORARROW       101    // RW bool; Enable arrow cursor
#define LC_PROP_G_CURSORCROSS       102    // RW bool; Enable crosshair cursor
#define LC_PROP_G_CURSORSIZE        103    // RW int; Size of crosshair cursor
#define LC_PROP_G_AUTOSELECT        110    // RW bool; Auto select by point
#define LC_PROP_G_PICKFIRST         111    // RW bool; Controls whether you select objects before (noun-verb selection) or after you issue a command
#define LC_PROP_G_PICKAUTO          112    // RW bool; Controls automatic windowing at the Select Objects prompt
#define LC_PROP_G_PICKDRAG          113    // RW bool; Controls the method of drawing a selection window
#define LC_PROP_G_PICKADD           114    // RW bool; Controls whether subsequent selections replace the current selection set or add to it
#define LC_PROP_G_PICKBOXSIZE       115    // RW int; Half-size of selecting square, in pixels
#define LC_PROP_G_AUTOUNSELECT      116    // RW bool; Determines state of selected entities after edit command was executed
#define LC_PROP_G_SELBYLAYER        117    // RW bool; Allows selection only on current layer
#define LC_PROP_G_SELINSIDE         118    // RW bool; Allows selection by click on inner area of closed and filled objects
#define LC_PROP_G_ENABLEGRIPS       119    // RW bool; Grips visibility when user selects an entities
#define LC_PROP_G_GRIPSIZE          120    // RW int; Size of grip square, in pixels
#define LC_PROP_G_GRIPCOLOR         121    // RW int; Grips color (COLORREF)
#define LC_PROP_G_GRIPSLIMIT        122    // RW int; Max number of entities to display grips
#define LC_PROP_G_SELCOLOR          123    // RW int; Color of selected objects (COLORREF)
#define LC_PROP_G_DRAGCOLOR         124    // RW int; Color of dragged objects (COLORREF)
#define LC_PROP_G_DLGRECENT         125    // RW bool; Display dialog "Recent Files" at startup
#define LC_PROP_G_AXES              139    // RW bool; visibility of Axes
#define LC_PROP_G_AXESTOP           140    // RW bool; visibility of Axes on Top view (ignored if LC_PROP_G_AXES==false)
#define LC_PROP_G_GETDELENT         143    // RW bool; controls if lcBlockGetEnt... function will retrieve deleted entities or not
#define LC_PROP_G_WNDSTYLE          144    // RW int; Litecad window style (used when OCX object is created)  // undoc
#define LC_PROP_G_OCXSAVECFG        145    // RW bool; defines if OCX will save config or not  // undoc
#define LC_PROP_G_INITCOUNT         146    // R  int;  // undoc
#define LC_PROP_G_CMDFONT           147    // RW string; font for command window
#define LC_PROP_G_CMDFONTSIZE       148    // RW int; font size for command window
#define LC_PROP_G_ANGSEPDMS         149    // RW string; code of separator symbol for "Deg,Min,Sec" angle units
#define LC_PROP_G_ADDRECENT         150    // RW bool; defines if lcDrwLoad will add a filename into recent files list  // undoc
...
#define LC_PROP_WND_COMMAND         323    // R  int; Id of active command   // undoc
...
#define LC_PROP_DRW_LTSCALE         513    // RW float; Linetype scale
...
#define LC_PROP_DRW_LWEIGHT         518    // RW int; Lineweight
#define LC_PROP_DRW_LWDEFAULT       519    // RW int; Default lineweight
#define LC_PROP_DRW_LWSCALE         520    // RW int; Scale to display lineweights
#define LC_PROP_DRW_LWDISPLAY       521    // RW bool; "Display lineweights" flag
#define LC_PROP_DRW_SYNCZOOM        522    // RW bool; "Synchronize Layouts zoom" flag 
...
#define LC_PROP_TABLE_DELETED       1004  // R  bool; "Deleted" flag    
#define LC_PROP_TABLE_DRW           1005  // R  handle; Handler to owner drawing 
#define LC_PROP_TABLE_ODHANDLE      1005  // RW string; used to save DWGdirect handle  // undoc
#define LC_PROP_TABLE_PRIORITY      1006  // RW int; priority for sorting   
#define LC_PROP_TABLE_XDATASIZE     1007  // RW int; size of extra data (bytes)
#define LC_PROP_TABLE_XDATA         1008  // RW handle; pointer to extra data  
#define LC_PROP_TABLE_XSTR          1009  // RW string; user string (uses XDATA buffer) 
#define LC_PROP_TABLE_INT0          1010  // RW int; user value  
#define LC_PROP_TABLE_INT1          1011  // RW int; user value  
#define LC_PROP_TABLE_INT2          1012  // RW int; user value  
#define LC_PROP_TABLE_INT3          1013  // RW int; user value  
#define LC_PROP_TABLE_INT4          1014  // RW int; user value  
#define LC_PROP_TABLE_FLOAT0        1015  // RW float; user value
#define LC_PROP_TABLE_FLOAT1        1016  // RW float; user value
#define LC_PROP_TABLE_FLOAT2        1017  // RW float; user value
#define LC_PROP_TABLE_FLOAT3        1018  // RW float; user value
#define LC_PROP_TABLE_FLOAT4        1019  // RW float; user value

// Layer
#define LC_PROP_LAYER__MIN          1020 
#define LC_PROP_LAYER_ID            1021  // R  int64|string; Unique Identifier
#define LC_PROP_LAYER_NAME          1022  // RW string; Layer Name
#define LC_PROP_LAYER_DESC          1023  // RW string; Description
#define LC_PROP_LAYER_DELETED       1024  // R  bool; "Deleted" flag
#define LC_PROP_LAYER_COLOR         1025  // RW string; Color
#define LC_PROP_LAYER_BCOLOR        1026  // RW string; Border Color  
#define LC_PROP_LAYER_COLORI        1027  // RW int; R bool; Color Index
#define LC_PROP_LAYER_COLORT        1028  // RW int; R bool; True Color
#define LC_PROP_LAYER_BCOLORI       1029  // RW int; R bool; Border Color Index
#define LC_PROP_LAYER_BCOLORT       1030  // RW int; R bool; Border True Color
#define LC_PROP_LAYER_LINETYPE      1031  // RW handle|string; Handle to Linetype|Name of Linetype
#define LC_PROP_LAYER_LWEIGHT       1032  // RW int; Lineweight
#define LC_PROP_LAYER_LOCKED        1033  // RW bool; "No edit" flag
#define LC_PROP_LAYER_NOPRINT       1034  // RW bool; "Not printed" flag
#define LC_PROP_LAYER_VISIBLE       1035  // RW bool; "Visible"; flag
#define LC_PROP_LAYER_0             1036  // R  bool; "Layer 0" flag
#define LC_PROP_LAYER_DRW           1037  // R  handle; Handle to owner drawing~
#define LC_PROP_LAYER_NODLG         1038  // RW bool; not displayed in the "Layers" dialog   // undoc
#define LC_PROP_LAYER__MAX          1040

// Linetype
#define LC_PROP_LINETYPE__MIN       1041 
#define LC_PROP_LINETYPE_ID         1041  // R  int64|string; Unique Identifier
#define LC_PROP_LINETYPE_NAME       1042  // RW string; Linetype Name
#define LC_PROP_LINETYPE_DESC       1043  // RW string; Description
#define LC_PROP_LINETYPE_DELETED    1044  // R  bool; "Deleted" flag
#define LC_PROP_LINETYPE_DATA       1045  // RW string; Linetype data in text form
#define LC_PROP_LINETYPE_SCALE      1046  // RW float; Global scale for this linetype
#define LC_PROP_LINETYPE_CONTINUOUS 1047  // R  bool; "Continuous" flag
#define LC_PROP_LINETYPE_BYLAYER    1048  // R  bool; "By Layer" flag
#define LC_PROP_LINETYPE_BYBLOCK    1049  // R  bool; "By Block" flag
#define LC_PROP_LINETYPE_STD        1050  // R  bool; standard linetype ("Continuous" or "By Layer" or "By Block")     // undoc
#define LC_PROP_LINETYPE_PATLEN     1051  // R  float; Pattern length
#define LC_PROP_LINETYPE_DRW        1052  // R  handle; Handle to owner drawing~
#define LC_PROP_LINETYPE_NELEM      1053  // R  int; number of elements
#define LC_PROP_LINETYPE_IELEM      1054  // W  int; set index of active element
#define LC_PROP_LTELEM_LEN          1055  // R  float; segment length
#define LC_PROP_LTELEM_COMPLEX      1056  // R  bool; TRUE - element contains shape or text
#define LC_PROP_LTELEM_SHAPE        1057  // R  bool; TRUE - text style is used, FALSE - draw only szText[0] and fontfile is used
#define LC_PROP_LTELEM_TEXT         1058  // R  string; Text
#define LC_PROP_LTELEM_STYLE        1059  // R  handle; text style (valid if LC_PROP_LTELEM_SHAPE is FALSE)
#define LC_PROP_LTELEM_FONTNAME     1060  // R  string; fontname (valid if LC_PROP_LTELEM_SHAPE is TRUE)
#define LC_PROP_LTELEM_SCALE        1061  // R  float; shape scale
#define LC_PROP_LTELEM_ANGLE        1062  // R  float; rotation angle in radians for a text element in the linetype
#define LC_PROP_LTELEM_ABSANGLE     1063  // R  bool; if TRUE - RotAngle is absolute 
#define LC_PROP_LTELEM_X            1064  // R  float; x offset of a shape
#define LC_PROP_LTELEM_Y            1065  // R  float; y offset of a shape
#define LC_PROP_LINETYPE__MAX       1070

// Text style
#define LC_PROP_TSTYLE__MIN         1071
#define LC_PROP_TSTYLE_ID           1071  // R  int64|string; Unique Identifier
#define LC_PROP_TSTYLE_NAME         1072  // RW string; Style Name
#define LC_PROP_TSTYLE_DESC         1073  // RW string; Description
#define LC_PROP_TSTYLE_DELETED      1074  // R  bool; "Deleted" flag
#define LC_PROP_TSTYLE_FONT         1075  // RW string; Font filename
#define LC_PROP_TSTYLE_HEIGHT       1076  // RW float; Default height
#define LC_PROP_TSTYLE_WSCALE       1077  // RW float; Default width scale
#define LC_PROP_TSTYLE_OBLIQUE      1078  // RW float; Default obluque angle
#define LC_PROP_TSTYLE_ANGLE        1079  // RW float; Default rotation angle
#define LC_PROP_TSTYLE_ALIGN        1080  // RW int; Default alignment
#define LC_PROP_TSTYLE_UPDOWN       1081  // RW bool; "Upside down" flag
#define LC_PROP_TSTYLE_BACKWARD     1082  // RW bool; "Backward" flag
#define LC_PROP_TSTYLE_LINESPACE    1083  // RW float; Default linespace
#define LC_PROP_TSTYLE_CHARSPACE    1084  // RW float; Default charspace
#define LC_PROP_TSTYLE_STANDARD     1085  // R  bool; "Standard" flag
#define LC_PROP_TSTYLE_SHAPES       1086  // R  bool; "Shapes" flag
//#define LC_PROP_TSTYLE_LCFONT       1087  // R  bool; if TRUE - Litecad LCF font is used
#define LC_PROP_TSTYLE_WINFONT      1087  // R  bool; if TRUE - Windows True Type font is used
#define LC_PROP_TSTYLE_BOLD         1088  // RW bool; "Bold" flag (for LC_ENT_TEXTWIN)
#define LC_PROP_TSTYLE_ITALIC       1089  // RW bool; "Italic" flag (for LC_ENT_TEXTWIN)
#define LC_PROP_TSTYLE_UNDERLINE    1090  // RW bool; "Underline" flag (for LC_ENT_TEXTWIN)
#define LC_PROP_TSTYLE_STRIKEOUT    1091  // RW bool; "Strikeout" flag (for LC_ENT_TEXTWIN)
#define LC_PROP_TSTYLE_DRW          1092  // R  handle; Handle to owner drawing
#define LC_PROP_TSTYLE__MAX         1100

// Dimension style
#define LC_PROP_DIMST__MIN          1101
#define LC_PROP_DIMST_ID            1101  // R  int64|string; Unique Identifier
#define LC_PROP_DIMST_NAME          1102  // RW string;
#define LC_PROP_DIMST_DESC          1103  // RW string;
#define LC_PROP_DIMST_DELETED       1104  // R  bool;
#define LC_PROP_DIMST_STANDARD      1114  // R  bool;
#define LC_PROP_DIMST_DRW           1115  // R  handle;
#define LC_PROP_DIMST_TSTYLE        1116  // RW handle|string; Text style
#define LC_PROP_DIMST__MAX          1130


// Block
#define LC_PROP_BLOCK__MIN          1131
#define LC_PROP_BLOCK_ID            1131  // R  int64|string;
#define LC_PROP_BLOCK_NAME          1132  // RW string;
#define LC_PROP_BLOCK_DESC          1133  // RW string;
#define LC_PROP_BLOCK_DELETED       1134  // R  bool;
#define LC_PROP_BLOCK_X             1135  // RW float;
#define LC_PROP_BLOCK_Y             1136  // RW float;
#define LC_PROP_BLOCK_Z             1137  // RW float;
#define LC_PROP_BLOCK_UFSCALING     1138  // RW bool;
#define LC_PROP_BLOCK_UNITS         1139  // RW int;
#define LC_PROP_BLOCK_UNITSCALE     1140  // R  float;
#define LC_PROP_BLOCK_MODEL         1141  // R  bool;
#define LC_PROP_BLOCK_PAPER         1142  // R  bool;
#define LC_PROP_BLOCK_LAYOUT        1143  // R  bool;  MODEL or  PAPER
#define LC_PROP_BLOCK_STANDARD      1144  // R  bool;
#define LC_PROP_BLOCK_HIDDEN        1145  // R  bool;
#define LC_PROP_BLOCK_DIM           1146  // R  bool;
#define LC_PROP_BLOCK_HATCH         1147  // R  bool;
#define LC_PROP_BLOCK_DRW           1148  // R  handle; Handle to owner drawing
#define LC_PROP_BLOCK_NOBJ          1149  // R  int; number of graphic objects (not deleted) in the block
#define LC_PROP_BLOCK_NSELOBJ       1150  // R  int; number of selected objects
#define LC_PROP_BLOCK_ATTRIBS       1157  // R  bool;  "Block has attributes" flag
#define LC_PROP_BLOCK_BASE          1159  //   for event
#define LC_PROP_BLOCK__MAX          1160

// View
#define LC_PROP_VIEW__MIN           1161
#define LC_PROP_VIEW_ID             1161  // R  int64|string; Unique Identifier
#define LC_PROP_VIEW_NAME           1162  // RW string;
#define LC_PROP_VIEW_DESC           1163  // RW string;
#define LC_PROP_VIEW_DELETED        1164  // R  bool;
#define LC_PROP_VIEW_BLOCK          1165  // RW handle|string; Handle to Block|Name of Block
#define LC_PROP_VIEW_MODEL          1166  // R  bool;
#define LC_PROP_VIEW_PAPER          1168  // R  bool;
#define LC_PROP_VIEW_XMIN           1173  // R  float;
#define LC_PROP_VIEW_YMIN           1174  // R  float;
#define LC_PROP_VIEW_XMAX           1175  // R  float;
#define LC_PROP_VIEW_YMAX           1176  // R  float;
#define LC_PROP_VIEW_LEF            1177  // R  float;
#define LC_PROP_VIEW_BOT            1178  // R  float;
#define LC_PROP_VIEW_RIG            1179  // R  float;
#define LC_PROP_VIEW_TOP            1180  // R  float;
#define LC_PROP_VIEW_PIXELSIZE      1181  // R  float;
#define LC_PROP_VIEW_PICKBOXSIZE    1182  // R  float;
#define LC_PROP_VIEW_LIMITS         1185  // RW bool;
#define LC_PROP_VIEW_COLORBACK      1186  // R  int; (COLORREF)
#define LC_PROP_VIEW_COLORFORE      1187  // R  int; (COLORREF)
#define LC_PROP_VIEW_COLORCURSOR    1188  // R  int; (COLORREF)
#define LC_PROP_VIEW_GRID           1191  // RW bool;
#define LC_PROP_VIEW_GRIDSNAP       1192  // RW bool;
#define LC_PROP_VIEW_OSNAP          1193  // RW bool;
#define LC_PROP_VIEW_OSNAPMODE      1194  // RW int;
#define LC_PROP_VIEW_PTRACK         1195  // RW bool;
#define LC_PROP_VIEW_ORTHO          1196  // RW bool;
#define LC_PROP_VIEW_ORDER          1230  // RW int;
#define LC_PROP_VIEW_DRW            1231  // R  handle;
#define LC_PROP_PAPER_SIZE          1241  // R  int; Paper size
#define LC_PROP_PAPER_ORIENT        1242  // R  int; Paper orientation 
#define LC_PROP_PAPER_W             1243  // R  float; Paper width, mm 
#define LC_PROP_PAPER_H             1244  // R  float; Paper height, mm 
#define LC_PROP_PAPER_X0            1245  // R  float; X coordinate of paper left-bottom corner 
#define LC_PROP_PAPER_Y0            1246  // R  float; Y coordinate of paper left-bottom corner 
#define LC_PROP_PAPER_INCH          1247  // RW bool; original paper units (used when import drawing from DWG)
#define LC_PROP_VIEW__MAX           1238

// Raster Image 
#define LC_PROP_IMAGE__MIN          1301 
#define LC_PROP_IMAGE_ID            1301  // R  int64|string; Unique Identifier
#define LC_PROP_IMAGE_NAME          1302  // RW string Image name 
#define LC_PROP_IMAGE_DESC          1303  // RW string Image description 
#define LC_PROP_IMAGE_DELETED       1304  // R  bool;
#define LC_PROP_IMAGE_FILENAME      1305  // RW string Image filename 
#define LC_PROP_IMAGE_SIZE          1306  // R  int    Image size, bytes 
#define LC_PROP_IMAGE_WPIX          1307  // R  int    Image width (pixels) 
#define LC_PROP_IMAGE_HPIX          1308  // R  int    Image height (pixels) 
#define LC_PROP_IMAGE_CBIT          1309  // R  int    Color bits 
#define LC_PROP_IMAGE_DRW           1310  // R  handle Handle to owner drawing 
#define LC_PROP_IMAGE__MAX          1330 
...
#define LC_PROP_ENT_PRIORITY      3029  // RW int; priority for sorting
...
//#define LC_PROP_POINT_Z          3104  // RW float;
...
#define LC_PROP_ARC_FILLED       3247  // RW bool; Filled arc
#define LC_PROP_ARC_BORDER       3248  // RW bool; Have border (for filled)
#define LC_PROP_ARC_SECTOR       3249  // RW bool; Draw as sector
#define LC_PROP_ARC_CENTER       3250  //   for event
...
#define LC_PROP_ELL_ANGLE        3266  // RW float; Rotation angle 
#define LC_PROP_ELL_ANG0         3267  // RW float; Start angle (for elliptical arc) 
#define LC_PROP_ELL_ANGARC       3268  // RW float; Arc included angle. Positive - counter-clockwise,
#define LC_PROP_ELL_ANGEND       3269  // R  float; End angle
#define LC_PROP_ELL_X0           3270  // R  float; Start point X
#define LC_PROP_ELL_Y0           3271  // R  float; Start point Y
...
#define LC_PROP_ELL_FILLED       3278  // RW bool;  "Filled ellipse" flag 
#define LC_PROP_ELL_BORDER       3279  // RW bool;  "Have border" flag (for filled) 
#define LC_PROP_ELL_SECTOR       3280  // RW bool;  "Draw as sector" flag 
#define LC_PROP_ELL_CENTER       3281  //   for event
#define LC_PROP_ELL__MAX         3290
...
#define LC_PROP_MLINE_JUST       3352  // RW int; justification
...
#define LC_PROP_TEXT_LEN         3403  // R  int; Number of characters in the Text string
#define LC_PROP_TEXT_ALIGN       3404  // RW int; Alignment type
#define LC_PROP_TEXT_X           3405  // RW float; Insertion point X
#define LC_PROP_TEXT_Y           3406  // RW float; Insertion point Y
...
#define LC_PROP_TEXTW_LEN        3433  // R  int; Number of characters in the Text string
#define LC_PROP_TEXTW_ALIGN      3434  // RW int; Alignment type
#define LC_PROP_TEXTW_X          3435  // RW float; Insertion point X
#define LC_PROP_TEXTW_Y          3436  // RW float; Insertion point Y
...
#define LC_PROP_ATEXT_LEN        3483  // R  int;
#define LC_PROP_ATEXT_X          3484  // RW float; Center X
#define LC_PROP_ATEXT_Y          3485  // RW float; Center Y
#define LC_PROP_ATEXT_RADIUS     3487  // RW float; Radius
#define LC_PROP_ATEXT_ANGLE      3488  // RW float; Start Angle
#define LC_PROP_ATEXT_CW         3489  // RW bool; Clockwise direction
#define LC_PROP_ATEXT_H          3490  // RW float; Height
#define LC_PROP_ATEXT_WSCALE     3491  // RW float; Width scale
#define LC_PROP_ATEXT_CHARSPACE  3492  // RW float; Charspace
#define LC_PROP_ATEXT_ALIGN      3493  // RW int;
#define LC_PROP_ATEXT_POS        3494  //   for event
#define LC_PROP_ATEXT__MAX       3499

// Attribute definition & Attribute
#define LC_PROP_ATT__MIN         3501
#define LC_PROP_ATT_MODE         3501  // RW int; 
#define LC_PROP_ATT_STYLE        3502  // RW handle|string; Handle to text style|Name of text style
#define LC_PROP_ATT_TAG          3503  // RW string;
#define LC_PROP_ATT_PROMPT       3504  // RW string;
#define LC_PROP_ATT_VALUE        3505  // RW string;
...
#define LC_PROP_VPORT__MIN       3601
#define LC_PROP_VPORT_LEF        3603  // RW float; Left side
#define LC_PROP_VPORT_BOT        3604  // RW float; Bottom side
#define LC_PROP_VPORT_RIG        3605  //
#define LC_PROP_VPORT_TOP        3606  //
#define LC_PROP_VPORT_W          3607  // RW float; Width
#define LC_PROP_VPORT_H          3608  // RW float; Height
#define LC_PROP_VPORT_VX         3609  // RW float; View center X on the projection
#define LC_PROP_VPORT_VY         3610  // RW float; View center Y on the projection
#define LC_PROP_VPORT_VSCALE     3611  // RW float; View scale
#define LC_PROP_VPORT_VANGLE     3612  // RW float; View rotation angle
#define LC_PROP_VPORT_FIXSCALE   3613  // RW bool; fixed scale
#define LC_PROP_VPORT_NFL        3614  // R  int; Number of frozen layers
#define LC_PROP_VPORT_RECT       3615  //   for event
#define LC_PROP_VPORT_VRECT      3616  //   for event
#define LC_PROP_VPORT__MAX       3630
...
#define LC_PROP_HATCH__MAX       3670 

// ECW / Jpeg2000 Image
#define LC_PROP_ECW__MIN         3901  
#define LC_PROP_ECW_FILENAME     3901  // R  string; Image filename
#define LC_PROP_ECW_LOADED       3902  // R  bool; "Image is loaded" flag 
#define LC_PROP_ECW_XMIN         3903  // R  float; X coordinate of left-bottom corner
#define LC_PROP_ECW_YMIN         3904  // R  float; Y coordinate of left-bottom corner
#define LC_PROP_ECW_XMAX         3905  // R  float; X coordinate of right-top corner
#define LC_PROP_ECW_YMAX         3906  // R  float; Y coordinate of right-top corner
#define LC_PROP_ECW_W            3907  // R  float; Width (drawing units)
#define LC_PROP_ECW_H            3908  // R  float; Height (drawing units)
#define LC_PROP_ECW_WPIX         3909  // R  int; Width (pixels)
#define LC_PROP_ECW_HPIX         3910  // R  int; Height (pixels)
#define LC_PROP_ECW_CBIT         3911  // R  int; Color bits
#define LC_PROP_ECW_SCALEX       3912  // R  float;
#define LC_PROP_ECW_SCALEY       3913  // R  float;
#define LC_PROP_ECW_BORDER       3914  // RW bool; "Draw a border" flag 
#define LC_PROP_ECW__MAX         3920 
...
#define LC_PROP_DIMANG__MIN      4021
#define LC_PROP_DIMANG_CPX       4021  // RW float; center point 1
#define LC_PROP_DIMANG_CPY       4022  // RW float; 
#define LC_PROP_DIMANG_DP1X      4023  // RW float; definition point 1
#define LC_PROP_DIMANG_DP1Y      4024  // RW float; 
#define LC_PROP_DIMANG_DP2X      4025  // RW float; definition point 2
#define LC_PROP_DIMANG_DP2Y      4026  // RW float; 
#define LC_PROP_DIMANG_DP3X      4027  // RW float; definition point 3
#define LC_PROP_DIMANG_DP3Y      4028  // RW float; 
#define LC_PROP_DIMANG_DP4X      4029  // RW float; definition point 4
#define LC_PROP_DIMANG_DP4Y      4030  // RW float; 
#define LC_PROP_DIMANG_APX       4031  // RW float; arc point X
#define LC_PROP_DIMANG_APY       4032  // RW float; arc point Y
#define LC_PROP_DIMANG_EXT1      4033  // RW bool; visibility of extention line 1
#define LC_PROP_DIMANG_EXT2      4034  // RW bool; visibility of extention line 2
#define LC_PROP_DIMANG_RAD       4035  // R  float; radius of dim arc
#define LC_PROP_DIMANG_TPOS      4036  // RW float; text position on arc
#define LC_PROP_DIMANG_CP        4037  //   for event
#define LC_PROP_DIMANG_DP1       4038  //   for event
#define LC_PROP_DIMANG_DP2       4039  //   for event
#define LC_PROP_DIMANG_DP3       4040  //   for event
#define LC_PROP_DIMANG_DP4       4041  //   for event
#define LC_PROP_DIMANG_AP        4042  //   for event
#define LC_PROP_DIMANG_TP        4043  //   for event
#define LC_PROP_DIMANG__MAX      4021
...
#define LC_PROP_DIMDIA_TPX       4075  // RW float; text point
#define LC_PROP_DIMDIA_TPY       4076  // RW float;
#define LC_PROP_DIMDIA_CP        4077  //   for event
#define LC_PROP_DIMDIA_RP        4078  //   for event
#define LC_PROP_DIMDIA_TP        4079  //   for event
...
#define LC_PROP_LEADER_LDIST     4510  // RW float; landing distance
#define LC_PROP_LEADER_VERT      4511  // RW bool; vertical line
#define LC_PROP_LEADER_CORNER    4512  // RW bool; attachment at corner
#define LC_PROP_LEADER_ATTACH    4513  //   for event
#define LC_PROP_LEADER_TP        4514  //   for event
#define LC_PROP_LEADER_AP        4515  //   for event
...
// for segment fro current to next vertex
...
LPCWSTR LCAPI lcCfgGetValue   (HANDLE hCfg, LPCWSTR szTag);        // F_CFGLOAD
BOOL    LCAPI lcCfgSetValue   (HANDLE hCfg, LPCWSTR szTagValue);   // F_CFGSAVE
...
BOOL   LCAPI lcEntUpdate    (HANDLE hEnt);         // undoc
...
void LCAPI qweGetFirstLine (void* pLine);
BOOL LCAPI qweGetNextLine  (void* pLine);
BOOL LCAPI asdGetPoint (UINT i, double* pX, double* pY);
...
typedef void (CALLBACK* F_ENTSCALE)     (HANDLE hEnt, double X0, double Y0, double Scale, bool bDrag);
