...
#define CMD_FILLET  LC_CMD_CUSTOM+5
...
void CALLBACK EventCmdString    (HANDLE hCmd, LPCWSTR szStr);
...
//  ::SendMessage( hwStatBar, SB_SIMPLE, TRUE, 0 );
  ...
  lcOnEventCmdString( EventCmdString );
  ...
  switch (message){
    case WM_COMMAND:
      ...
      switch( wmId ){
        ...
        case ID_DRAW_RECTANGLE: lcWndExeCommand( hLcWnd, LC_CMD_RECT, 0 ); break;
        ...
        case ID_CCMD_FILLET: lcWndExeCommand( hLcWnd, CMD_FILLET, 0 ); break;
...
void CALLBACK EventAddCommand (HANDLE hLcWnd)
{
  CmdSketch_Create( hLcWnd, CMD_SKETCH, L"SKETCH" );
  CmdFlip_Create( hLcWnd, CMD_FLIP  , L"FLIP" );
  CmdArrow_Create( hLcWnd, CMD_ARROW , L"ARROW" );
  CmdWall_Create( hLcWnd, CMD_WALL , L"WALL" );
  CmdWall_Create( hLcWnd, CMD_FILLET , L"FILLET" );
}

//-----------------------------------------------
void CALLBACK EventCmdStart (HANDLE hCmd, int Prm)
{
  int Id = lcPropGetInt( hCmd, LC_PROP_CMD_ID );
  switch( Id ){
    case CMD_SKETCH: CmdSketch_Start( hCmd, Prm ); break;
    case CMD_FLIP:   CmdFlip_Start( hCmd, Prm ); break;
    case CMD_ARROW:  CmdArrow_Start( hCmd, Prm ); break;
    case CMD_WALL:   CmdWall_Start( hCmd, Prm ); break;
    case CMD_FILLET: CmdFillet_Start( hCmd, Prm ); break;
  }
}
...
void CALLBACK EventCmdFinish (HANDLE hCmd)
{
  int Id = lcPropGetInt( hCmd, LC_PROP_CMD_ID );
  switch( Id ){
    case CMD_SKETCH: CmdSketch_Finish( hCmd ); break;
    case CMD_FLIP:   CmdFlip_Finish( hCmd ); break;
    case CMD_ARROW:  CmdArrow_Finish( hCmd ); break;
    case CMD_WALL:   CmdWall_Finish( hCmd ); break;
    case CMD_FILLET: CmdFillet_Finish( hCmd ); break;
  }
}
...
void CALLBACK EventCmdString (HANDLE hCmd, LPCWSTR szStr)
{
  int Id = lcPropGetInt( hCmd, LC_PROP_CMD_ID );
  switch( Id ){
    case CMD_SKETCH: CmdSketch_String( hCmd, szStr ); break;
    case CMD_FLIP:   CmdFlip_String( hCmd, szStr ); break;
    case CMD_ARROW:  CmdArrow_String( hCmd, szStr ); break;
    case CMD_WALL:   CmdWall_String( hCmd, szStr ); break;
    case CMD_FILLET: CmdFillet_String( hCmd, szStr ); break;
  }
}
...
void CALLBACK EventCmdMouseDown (HANDLE hCmd, int Button, int Flags, int Xwin, int Ywin, double X, double Y)
{
  int Id = lcPropGetInt( hCmd, LC_PROP_CMD_ID );
  switch( Id ){
    case CMD_SKETCH: CmdSketch_MouseDown( hCmd, Button, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_FLIP:   CmdFlip_MouseDown( hCmd, Button, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_ARROW:  CmdArrow_MouseDown( hCmd, Button, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_WALL:   CmdWall_MouseDown( hCmd, Button, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_FILLET: CmdFillet_MouseDown( hCmd, Button, Flags, Xwin, Ywin, X, Y ); break;
  }
}
...
void CALLBACK EventCmdMouseUp (HANDLE hCmd, int Button, int Flags, int Xwin, int Ywin, double X, double Y)
{
  int Id = lcPropGetInt( hCmd, LC_PROP_CMD_ID );
  switch( Id ){
    case CMD_SKETCH: CmdSketch_MouseUp( hCmd, Button, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_FLIP:   CmdFlip_MouseUp( hCmd, Button, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_ARROW:  CmdArrow_MouseUp( hCmd, Button, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_WALL:   CmdWall_MouseUp( hCmd, Button, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_FILLET: CmdFillet_MouseUp( hCmd, Button, Flags, Xwin, Ywin, X, Y ); break;
  }
}
...
void CALLBACK EventCmdMouseMove (HANDLE hCmd, HDC hDC, int Flags, int Xwin, int Ywin, double X, double Y)
{
  int Id = lcPropGetInt( hCmd, LC_PROP_CMD_ID );
  switch( Id ){
    case CMD_SKETCH: CmdSketch_MouseMove( hCmd, hDC, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_FLIP:   CmdFlip_MouseMove( hCmd, hDC, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_ARROW:  CmdArrow_MouseMove( hCmd, hDC, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_WALL:   CmdWall_MouseMove( hCmd, hDC, Flags, Xwin, Ywin, X, Y ); break;
    case CMD_FILLET: CmdFillet_MouseMove( hCmd, hDC, Flags, Xwin, Ywin, X, Y ); break;
  }
}
